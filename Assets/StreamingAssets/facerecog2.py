...
# interval of which emotions are captured from the camera
emotion_captured_interval = 3
...
while True:
    ...
    for face in faces:
        ...
        if w > min_face_size and h > min_face_size:
            ...
            if current_time - last_analyze_time >= emotion_captured_interval:
                ...
                if max_key == "happy" or "surprise":
                    print(0)
                elif max_key == "neutral" or "disgust":
                    print(-1)
                else :
                    print(1)
