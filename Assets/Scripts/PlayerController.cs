...
{    
    ...
    [SerializeField] public static double attackDamage1 = 25;
    [SerializeField] private Transform attackPoint2a;
    [SerializeField] private Transform attackPoint2b;
    [SerializeField] public static double attackDamage2 = 50;
    ...
    void Start()
    {
        ...
        playerCurrentHealth = (int)playerMaxHealth;
        healthBar.SetMaxHealth((int)playerMaxHealth);
    ...
    private void Hit1() // Player's primary (fast) attack - use in attack1 animation
    {
        ...
        {
            enemy.GetComponent<Enemy>().takeDamage((int)attackDamage1);
        }
        // Sound effect
    ...
    private void Hit2() // Player's secondary (slow) attack - use in attack2 animation
    {
        ...
        foreach (Collider2D enemy in hitEnemies)
        {
            enemy.GetComponent<Enemy>().takeDamage((int)attackDamage2);
        }
        // Sound effect
