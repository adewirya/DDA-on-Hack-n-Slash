...
public class Goblin : Enemy
{
    ...
    [SerializeField] public static double attackDamage1 = 0;
    ...
    void GoblinHit1()
    {
        ...
        if (hitPlayer != null) hitPlayer.GetComponent<PlayerController>().DamagePlayer((int)attackDamage1);
        AttackSound();
    }
    ...
    void AttackSound()
    {
        SoundController.sC.Play(audioSource, SoundController.sC.goblinAttack, 1f);
    }

    void WalkSound()
    {
        SoundController.sC.Play(audioSource, SoundController.sC.goblinWalk, 0.2f);
    }

    void HurtSound()
    {
        SoundController.sC.Play(audioSource, SoundController.sC.goblinHurt, 1f);
    }
    void DeathSound()
    {
        SoundController.sC.Play(audioSource, SoundController.sC.goblinDeath, 0.8f);
    }
}
